...
export default function Homepage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 flex flex-col">
      ...
      {/* Header is handled by app/layout.tsx */}
      ...
      <main className="flex-grow pt-24">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <div className="lg:w-1/2 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                  ...
                  {/* Replaced View Demo button with Log in Link */}
                  <Link 
                    href="/login"
        ...
        {/* Features Section - Optimized & Colored with #2169EA */}
        ...
        <section className="py-24 bg-white overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex gap-6 animate-scroll hover:pause-scroll w-max px-4">
              {/* We duplicate the testimonials to create an infinite loop illusion */}
      ...
      {/* Footer is handled by app/layout.tsx */}
